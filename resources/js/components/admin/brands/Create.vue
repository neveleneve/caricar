<template>
    <dashboard-layout>
        ...
        <div class="container mx-auto rounded-lg">
            <div
                class="p-6 rounded-lg bg-pastel-light-100 dark:bg-pastel-dark-700 shadow-md"
            >
                <div class="flex mb-6">
                    <router-link :to="'/administrator/brand'">
                        <button
                            class="flex items-center px-3 py-1.5 text-sm font-semibold text-white bg-pastel-red-800 rounded-lg hover:bg-pastel-red-700 focus:outline-none focus:ring-2 focus:ring-pastel-dark-500"
                        >
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <input
                                id="brandName"
                                v-model="brand.name"
                                class="w-full px-4 py-2 text-sm border rounded-lg bg-white dark:bg-pastel-dark-800 border-pastel-dark-300 dark:border-pastel-dark-600 text-pastel-dark-700 dark:text-pastel-light-500 focus:border-pastel-blue-800 focus:ring-pastel-blue-800 dark:focus:border-pastel-blue-700 dark:focus:ring-pastel-blue-700"
                            />
                        </div>
                    </div>
