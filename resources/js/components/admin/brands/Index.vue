                                    ...
                                    <template #row="{ item: brand }">
                                        ...
                                        <td class="text-right td">
                                            <Menu as="div" class="relative inline-block text-left">
                                                <div>
                                                    <MenuButton
                                                        class="inline-flex justify-center w-full px-4 py-1 text-sm font-medium rounded-md bg-pastel-light-600 dark:bg-pastel-dark-600 text-pastel-dark-800 dark:text-pastel-light-900 hover:bg-pastel-light-900 dark:hover:bg-pastel-dark-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75">
                                                        <span
                                                            class="text-pastel-dark-800 dark:text-pastel-light-900 material-icons">
                                                            more_horiz
                                                        </span>
                                                    </MenuButton>
                                                </div>
                                                <transition enter-active-class="transition duration-100 ease-out"
                                                    ...
                                                    <MenuItems
                                                        class="absolute z-50 w-56 mt-2 origin-top-right border divide-y rounded-md shadow-lg dark:border-pastel-dark-500 border-pastel-dark-200 -top-8 right-16 bg-pastel-light-700 dark:bg-pastel-dark-600 focus:outline-none">
                                                        <div class="px-1 py-1">
                                                            <MenuItem v-slot="{ active }">
                                                            <router-link
                                                                :to="{ name: 'brand_edit', params: { id: brand.id } }"
                                                                :class="[
                                                                    active ? 'bg-pastel-blue-800 text-pastel-light-500' : 'text-pastel-dark-900 dark:text-pastel-light-500',
                                                                    'group flex w-full items-center rounded-md px-2 py-2 text-sm',
                                                                ]">
                                                                <span :class="[
                                                                    active ? 'text-pastel-light-500' : 'text-pastel-dark-900 dark:text-pastel-light-900',
                                                                    'w-5 h-5 mr-2 material-icons'
                                                                ]">
                                                                    edit
                                                                </span>
                                                                Ubah
                                                            ...
                                                            <button
                                                                ...
                                                                :class="[
                                                                    active ? (brand.deleted_at ? 'bg-pastel-green-800 text-pastel-light-500' : 'bg-pastel-red-800 text-pastel-light-500 ') : 'text-pastel-dark-900 dark:text-pastel-light-900',
                                                                    'group flex w-full items-center rounded-md px-2 py-2 text-sm'
                                                                ]">
                                                                <span :class="[
                                                                    active ? 'text-pastel-light-500' : 'text-pastel-dark-900 dark:text-pastel-light-900',
                            ...
                            <div class="flex items-center justify-between p-1">
                                ...
                                <div class="relative ml-4">
                                    <Menu as="div" class="relative inline-block text-left">
                                        <div>
                                            <MenuButton
                                                class="inline-flex justify-center w-full px-1 py-4 text-sm font-medium rounded-md bg-pastel-light-700 dark:bg-pastel-dark-600 text-pastel-dark-800 dark:text-pastel-light-900 hover:bg-pastel-light-900 dark:hover:bg-pastel-dark-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75">
                                                <span
                                                    class="text-pastel-dark-800 dark:text-pastel-light-900 material-icons">
                                                    more_vert
                                                </span>
                                        ...
                                        <transition enter-active-class="transition duration-100 ease-out"
                                            ...
                                            leave-to-class="transform scale-95 opacity-0">
                                            <MenuItems
                                                class="absolute z-50 w-56 mt-2 origin-top-right border divide-y rounded-md shadow-lg dark:border-pastel-dark-600 border-pastel-dark-200 -top-6 right-10 bg-pastel-light-800 dark:bg-pastel-dark-800 focus:outline-none">
                                                <div class="px-1 py-1">
                                                    <MenuItem v-slot="{ active }">
...
import { Combobox, ComboboxInput, ComboboxOptions, ComboboxButton, ComboboxOption, Menu, MenuButton, MenuItems, MenuItem } from "@headlessui/vue";
