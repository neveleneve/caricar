            ...
            <div class="w-full max-w-md space-y-8">
                ...
                <div
                    ...
                    <div class="mb-8 text-center">
                        <h2 class="text-2xl font-bold text-pastel-dark-700 dark:text-pastel-light-500">Welcome!</h2>
                        <p class="mt-2 text-pastel-dark-700 dark:text-pastel-light-500">Please sign in to your account
                        </p>
                    </div>
