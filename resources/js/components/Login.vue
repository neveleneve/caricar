            ...
            <div class="w-full max-w-md space-y-8">
                ...
                <div
                    ...
                    <div class="mb-8 text-center">
                        <h2 class="text-2xl font-bold text-pastel-dark-700 dark:text-pastel-light-500">
                            Selamat Datang!
                        </h2>
                        <p class="mt-2 text-pastel-dark-700 dark:text-pastel-light-500">
                    ...
                    <form @submit.prevent="handleLogin" class="space-y-6">
                        <div>
                            ...
                            <div class="relative">
                                <input v-model="email" id="email" type="email" required class="input-login"
                        ...
                        <div class="flex items-center justify-between pb-2">
                            <span class="text-sm text-pastel-dark-700 dark:text-pastel-light-500">Mode Tampilan</span>
                            <button type="button" @click="toggleTheme" :disabled="themeStore.isTransitioning"
                                ...
                                <div class="relative inline-flex items-center w-12 h-6 transition-colors duration-300 rounded-full focus:outline-none focus:ring-2 focus:ring-pastel-dark-500"
                                    :class="{
                        ...
                        <button type="submit" :disabled="loading" class="button-login" :class="{ loading: loading }">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <button type="button" @click="handleFacebookLogin" disabled
                        ...
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <router-link to="/" title="Kembali ke beranda"
                                class="w-full py-3 mt-3 text-sm font-bold rounded-lg bg-pastel-red-800 hover:bg-pastel-red-700">
                                <div class="flex items-center justify-center font-bold text-pastel-light-100">
